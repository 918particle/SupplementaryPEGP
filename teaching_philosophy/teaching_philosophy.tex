...
\begin{itemize}
\item Challenge the students with course content that requires both analytic and creative thinking %Q11, Q20.
\item Provide the students with technical expertise and guidance %Q12, Q19
\end{itemize}
...
\begin{itemize}
\item Measurably strengthen the theoretical problem solving of the students %Q14
\item Expose students to numerical modeling with computer code and open-source software %Examples, GitHub
\item Assist the students with the design and execution of technical projects %Examples, GitHub
\item Strengthen the data analysis abilities of the students %Same as above
\end{itemize}
