...
The PI and PheT modules are outlined below for more detail and clarity, since it is likely that they are familiar mostly to physics instructors. \\ \hspace{0.1cm}
...
\begin{enumerate}
\item If the fraction of correct answers is $>0.7$, we proceed to the next exercise or new material\footnote{The number 0.7 was the recommended fraction at the AAPT conference I attended in 2017.}.
...
\begin{enumerate}
\item When a PhET tool re-creates a laboratory measurement, it is useful and informative to first simulate the expected results.
...
\item In special units, such as studying the behavior of electrical signals in the human body, there are useful PhET tools from biology, chemistry, and medicine earth science that to engage the curiosity of students.
\end{enumerate}
\end{itemize}
